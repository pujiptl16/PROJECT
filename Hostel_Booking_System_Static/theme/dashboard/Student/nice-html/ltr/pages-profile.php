...
{
    echo "<script>pages-profile.php'</script>";
}
                            ...
                            <div class="card-body">
                                <form class="form-horizontal form-material mx-2">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <select name="country" id="country" class="form-select shadow-none form-control-line">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-12">Select Country</label>
                                        <div class="col-sm-12">
                                            <select name="state" id="state" class="form-select shadow-none form-control-line">
