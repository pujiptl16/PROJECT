                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h6 class="card-title mt-5"><i class="me-1 font-18 mdi mdi-numeric-1-box-multiple-outline"></i> Available Packages
                                </h6>
                                ...
                                <div class="booking">
                                    <div class="hostelbox">
                                        <form class="form-horizontal form-material mx-2"">
                                            <div class="form-group">
                                                <input type='text' name='PackagePrice' id='PackagePrice' value="19999">
                                                <label>Pick a Package</label>
                                                <div class="col-sm-12">
                                                    <select name="package" id="package" class="form-select shadow-none form-control-line">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="hostelName" id="hostelName" class="form-select shadow-none form-control-line">
                                            ...
                                            <div class="form-group" style="justify-content:center; text-align:center; display:flex;">
                                                <div class="col-sm-12" style="width:20%;">
                                                    <button name="FindMap" class="btn btn-success text-white">Find</button>
                                                </div>
                                                <div class="col-sm-12" style="width:20%;">
                                                    <button name="NextMap" class="btn btn-success text-white">Next</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
                                    <div class="moviebox">
                                        <div class="room-map">
                                            ...
                                            <p class="text" style="text-align:center; margin:2%;">
                                                You have selected <span id="count">0</span> Room for a price of $<span id="total">0</span>
                                            </p>
                                    </div>
                                </div>
                            </div>
            ...
            if(document.getElementById('package').value != ""){
                if(document.querySelectorAll('.movie-row .seat.selected').length<1){
                    if (e.target.classList.contains('seat') && !e.target.classList.contains('occupied') && !e.target.classList.contains('whiteseat') && !e.target.classList.contains('staffuse')) {
                        ...
                        updateSelectedCount();
                        const seatsIndex = [...(document.querySelectorAll('.movie-row .seat.selected'))].map((seat) => [...seats].indexOf(seat));
                    }
                }
                else{
