                                    ...
                                    <?php if (isset($_SESSION['message'])): ?>
                                        ...
                                        <?php
                                            $hid = $_SESSION['Hostel_id'];
                                             $record = mysqli_query($db, "SELECT a.FirstName, a.LastName, a.EnrollmentNo, a.Email, a.DepartmentName, a.PhoneNo, b.Hostel_id, b.Room_id, c.Hostel_Name FROM tblregister a 
                                                        LEFT JOIN tblhostel_record b on b.user_id=a.user_id
                                                        LEFT JOIN tblhostel c on b.Hostel_id=c.Hostel_id
