      ...
      <nav class="navbar navbar-expand-lg navbar-dark px-0">
        ...
        <div class="collapse navbar-collapse" id="navbar01">
          <ul class="navbar-nav navigation-menu ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="index.php#our-team">Team</a>
            </li>
            <li class="nav-item">
    ...
    <div class="row">
      ...
      <article class="col-lg-4 col-md-6 mb-30 clearfix wow fadeInUp" data-wow-duration="500ms">
        <div class="post-block">
          ...
          <div class="content">
            <h3><a href="index.php">Simple Image Post</a></h3>
      ...
      <article class="col-lg-4 col-md-6 mb-30 wow fadeInUp" data-wow-duration="500ms"
        ...
        <div class="post-block">
          ...
          <div class="content">
            <h3><a href="index.php">Simple Slider Post</a></h3>
            <p>Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad
              squid. 3 wolf moon officia aute, non skateboard dolor brunch.</p>
            <a class="btn btn-transparent" href="blog-single.php">Read more</a>
          </div>
      ...
      <div class="col-12">
        <nav aria-label="Page navigation example">
          <ul class="pagination pagination-lg justify-content-center">
            <li class="page-item"><a class="page-link" href="blog.php">&laquo;</a></li>
            ...
            <li class="page-item"><a class="page-link" href="blog.php">&raquo;</a></li>
          </ul>
        </nav>
      </div>
    </div> <!-- end row -->
