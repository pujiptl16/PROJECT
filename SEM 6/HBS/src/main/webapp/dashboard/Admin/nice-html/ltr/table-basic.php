...
else
{
    ...
    if (isset($_POST['AddHostel'])) {
        ...
        $_SESSION['message'] = "Hostel Stored Successfully.";
        header('location: table-basic.php');
    }
                                ...
                                <?php if (isset($_GET['add'])) { ?>
                                    ...
                                    <div class="table-responsive">
                                            ...
                                            <?php if (isset($_SESSION['message'])): ?>
                                                ...
                                                <tr scope="col" <?php if($_SESSION['message'] == 'Hostel Deleted Successfully.'){ ?> class="table-danger" <?php } else { ?> class="table-success" <?php } ?>>
                                                    <th colspan='12'>
                                                            <center>
                                                            <?php
                                                ...
                                                <?php    
                                                    ...
                                                    { ?>
                                                        ...
                                                        <th scope="row"><?php echo $num; $num=$num+1; ?></th>
                                                            ...
                                                            <td><a href="table-basic.php?del=<?php echo $row['Hostel_id']; ?>" onclick="return checkDelete()">Delete</a></td>
                                                        </tr>
                                                        <?php } ?>
                                                </tbody>
                                            </table>
