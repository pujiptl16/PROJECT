                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <%
                                    ...
                                    String query = "SELECT sales_date, sales_total FROM sales_table";
                                    Statement stmt = null;
                                    ResultSet rs = null;
                                    try {
                                    ...
                                    // fetch data into arrays for chart
                                    ArrayList<String> dates = new ArrayList<String>();
                                    ArrayList<Integer> sales = new ArrayList<Integer>();
                                    try {
                                        while (rs.next()) {
                                            dates.add(rs.getString("sales_date"));
                                            sales.add(rs.getInt("sales_total"));
                                        }
                                    } catch (SQLException e) {
                                        e.printStackTrace();
                                    }
                                ...
                                $(function() {
                                    ...
                                    var chart = new Chartist.Line('.sales', salesData, {
                                        low: 0,
                                        high: 48,
                                        showArea: true,
                                        fullWidth: true,
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
	                                        <%
												...
												record = con.createStatement().executeQuery("SELECT * FROM `tblhostel`");
												int num = 1;
												while (record.next()) {
												%>
												  <tr>
												    ...
												    <td><%=record.getString("Capacity")%></td>
												    <td><%=record.getString("Address")%></td>
												    <td><%=record.getString("Hostel_Distance")%></td>
												    <td><%=record.getString("Hostel_Type")%></td>
												    <td>
												      <%
												        if(record.getString("Hostel_Status").equals("Available")) {
												      %>
												          <span class="label label-success label-rounded"><%=record.getString("Hostel_Status")%></span>
												      <%
												        } else if(record.getString("Hostel_Status").equals("Fast Filling")) {
												      %>
												          <span class="label label-info label-rounded"><%=record.getString("Hostel_Status")%></span>
												      <%
												        } else if(record.getString("Hostel_Status").equals("Full")) {
												      %>
												          <span class="label label-danger label-rounded"><%=record.getString("Hostel_Status")%></span>
												      <%
												        }
												      %>
												    </td>
